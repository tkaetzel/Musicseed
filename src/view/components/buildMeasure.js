...
class BuildMeasure extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <MeasureAttributeSelect measure={measure} attribute='upper' options={Array.from(Array(17).keys()).slice(1,17)} changeTimeSignature={e => this.changeTimeSignature(e)} />
                <MeasureAttributeSelect measure={measure} attribute='lower' options={[2, 4, 8, 16]} changeTimeSignature={e => this.changeTimeSignature(e)} />
            </div>
        );
    }
}
